...
export const products: Product[] = [
  ...
  },
  {
    ...
    intro:
      "The Waterproof LED BEE EYE combines a powerful 7x60 W RGBW engine with a 210‑LED pixel ring and individual pixel control to deliver stunning vortex, kaleidoscope, and waist effects across a massive 4°–60° zoom range. With an infinitely rotatable front mirror, multiple channel modes, and IP65-rated construction, it's built to dominate outdoor festivals, touring productions, and architectural installations—rain or shine.",
    image: "/images/fixtures/led660wbee.jpg",
    keySpecs: [
      { label: "Source", value: "High power TX 4x1 RGBW 7x60W" },
      { label: "Display", value: "OLED Touch Display" },
    ...
    highlights: [
      {
        title: "Pixel Effect",
        body: "Each LED and Color can be control individually.",
      },
      {
        title: "CMY plus linear CTO",
        body: "Subtractive colour mixing with a linear CTO flag for matching tungsten sources in mixed rigs.",
    ...
    specs: [
      ...
      },
      {
        group: "Colour & effects",
        rows: [
          ["Colour mixing", "Uniform RGBW Color Mixing "],
          ["Colour wheel", "14 colors + white light"],
          ["Gobo", "17 gobos + white circles"],
          ["Prisms", "One 16-prism, one 8+8+8 triple prism, and one 6-row prism, can be stacked."],
          ["Frost", "Two-stage, variable 0–100 %"],
          ...
          ["Strobe", "1 - 30 times per second electronic strobe and random strobe"],
        ],
      },
      {
        group: "Movement",
    ...
    dmxModes: [
      { mode: "Standard", channels: "20", use: "Full feature set, 16-bit movement" },
      { mode: "Extended", channels: "57", use: "Adds per-prism and CTO fine control" },
      { mode: "Compact", channels: "36", use: "Reduced footprint for large rigs" },
    ],
  },
  {
    slug: "IP65 Strike V",
  ...
  },
  {
    ...
    intro:
      "The 960 RGBW Strobe Light packs 864 RGB and 96 high‑power white LEDs into a compact 8+8 segment bar with individual pixel control. Its 32‑bit flicker‑free dimming, variable 1–30 Hz strobe, and multiple channel modes deliver dynamic chases, color washes, and burst effects—ideal for concerts, clubs, and touring productions.",
      image: "/images/fixtures/900pc.jpg",
        keySpecs: [
      { label: "Source", value: "960 pieces of 0.2W" },
      { label: "Optics", value: "120°" },
      { label: "Ingress", value: "IP65" },
      { label: "Weight", value: "5 kg" },
    ],
    highlights: [
      {
        title: "Rock‑solid aim",
        body: "Toothed locking yoke holds position under continuous outdoor vibration, with a built‑in witness scale for fast, accurate re‑aiming after maintenance.",
      },
      {
        title: "Built‑to‑last cooling",
        body: "Copper‑pipe heat conduction paired with waterproof silent fans keeps internal temperatures stable through punishing outdoor sets and long festival runs.",
      },
    ],
    specs: [
      {
        group: "Output",
        rows: [
          ["Light source", "960 pieces of 0.2W"],
          ["Beam angle", "120°"],
...
export const stats = [
  { value: "2016", label: "Manufacturing since" },
  { value: "4,100 m²", label: "Production floor" },
